        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-up">
            ...
            <p className="font-heading font-600 text-lg sm:text-xl text-warm-600 mb-6">
              An Integrated Therapy Center for Children with Special Needs
            </p>

            {/* Mission statement */}
            <p className="font-body text-base sm:text-lg text-muted-foreground leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
              We believe every child deserves the opportunity to grow, learn, and thrive. 
              Through compassionate, evidence-based therapies, we nurture each child's 
              unique potential and empower families on their journey.
            </p>
