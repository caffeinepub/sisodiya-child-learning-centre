...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-48 right-[12%] animate-float"
        style={{ animationDelay: "1s" }}
      >
        <Sparkles className="w-5 h-5 text-warm-400" />
      </div>
      <div
        className="absolute bottom-40 right-[8%] animate-float"
      ...
      <div className="container mx-auto px-4 sm:px-6 pt-24 pb-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-up">
            ...
            {/* Main heading */}
            <h1 className="font-heading font-900 text-3xl sm:text-4xl lg:text-5xl text-foreground leading-tight mb-4">
            ...
            <p className="font-heading font-600 text-lg sm:text-xl text-warm-600 mb-6">
              ...
              providing speech therapy, occupational therapy, special education
            ...
            <p className="font-body text-base sm:text-lg text-muted-foreground leading-relaxed mb-4 max-w-xl mx-auto lg:mx-0">
              At Sisodiya Child Learning Centre, we believe every child is
              special and full of potential. Our goal is to provide professional
              therapies in a caring and supportive environment so that every
              child can grow with confidence and independence.
            </p>
            <p className="font-body text-sm sm:text-base text-muted-foreground leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
              We provide personalized therapy programs for children with
              developmental delays, autism, speech delay, learning difficulties,
            ...
            <div className="flex items-center gap-3 justify-center lg:justify-start mb-8">
              <div className="w-10 h-10 rounded-full bg-warm-200 flex items-center justify-center">
                <span className="font-heading font-800 text-warm-700 text-sm">
                  PS
                </span>
              </div>
              <div>
                ...
                <p className="font-body text-xs text-muted-foreground">
                  Director, Sisodiya Child Learning Centre
                </p>
              </div>
            </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg">
              ...
              <div className="absolute -bottom-4 -right-4 bg-card rounded-2xl shadow-card p-3 border border-border">
                <p className="font-heading font-800 text-2xl text-sage-500">
                  100%
                </p>
                <p className="font-body text-xs text-muted-foreground">
                  Child-Centered
