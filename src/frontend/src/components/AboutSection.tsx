...
const values = [
  ...
  },
  {
    ...
    description: 'We work closely with parents to ensure consistent progress at home and in therapy sessions.',
    color: 'text-warm-600',
    bg: 'bg-warm-50',
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto">
            Sisodiya Child Learning Centre (Ek Nayi Ummeed) is dedicated to helping children with special needs
            through structured and individualized therapy programs.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            <div className="bg-warm-50 rounded-4xl p-8 border border-warm-100 mb-6">
              ...
              {/* Focus Areas */}
              <h4 className="font-heading font-700 text-base text-foreground mb-3">Our centre focuses on:</h4>
              <ul className="space-y-2 mb-5">
                {focusAreas.map((area) => (
                  <li key={area} className="flex items-start gap-2.5">
                    <CheckCircle className="w-4 h-4 text-sage-500 mt-0.5 flex-shrink-0" />
                    <span className="font-body text-sm text-muted-foreground">{area}</span>
                  </li>
                ))}
              </ul>
              ...
              <div className="bg-sage-50 border border-sage-100 rounded-2xl p-4">
                <p className="font-body text-sm text-sage-700 leading-relaxed">
                  <span className="font-heading font-700">Parent Partnership:</span>{' '}
